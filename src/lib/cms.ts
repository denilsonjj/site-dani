...
const fallbackSessionSeed: Array<Omit<SiteService, "category" | "currency" | "requiresPolicyAcceptance">> = [
  {
    ...
    description: "Consulta online indispensÃ¡vel para novos clientes, com recolha de informaÃ§Ãµes, dÃºvidas e plano personalizado.",
    duration: "1 hora Â· online via Zoom",
    ...
    text: "Encontro inicial para compreender a sua situaÃ§Ã£o e definir um plano personalizado.",
    title: "Primeira Consulta Online",
  },
  {
    amountCents: 15099,
    badge: "Pacote inicial",
    description: "Consulta inicial com restauraÃ§Ã£o vibracional e limpeza energÃ©tica completa.",
    ...
    text: "OpÃ§Ã£o indicada para quem inicia o trabalho e precisa de avaliaÃ§Ã£o antes da limpeza.",
    title: "Limpeza EnergÃ©tica Espiritual + Primeira Consulta",
  },
  {
    amountCents: 11499,
    badge: "Restauro",
    description: "SessÃ£o Ã  distÃ¢ncia para limpeza de cargas, equilÃ­brio dos corpos sutis e restauraÃ§Ã£o energÃ©tica.",
    duration: "SessÃ£o Ã  distÃ¢ncia",
    ...
    text: "RestauraÃ§Ã£o vibracional, limpeza de cargas e harmonizaÃ§Ã£o da aura.",
    title: "Limpeza EnergÃ©tica Espiritual",
  },
  {
    amountCents: 11499,
    badge: "Ambientes",
    description: "Atendimento Ã  distÃ¢ncia para harmonizar um ambiente e suavizar cargas densas.",
    duration: "1 ambiente",
    ...
    text: "Limpeza e equilÃ­brio energÃ©tico para residÃªncias ou espaÃ§os carregados.",
    title: "HarmonizaÃ§Ã£o de Ambiente",
  },
  {
    amountCents: 29400,
    badge: "Pacote",
    description: "HarmonizaÃ§Ã£o energÃ©tica Ã  distÃ¢ncia para atÃ© trÃªs residÃªncias.",
    duration: "AtÃ© 3 residÃªncias",
    image: "/services/original-environment-harmonization.webp",
    price: "294 â‚¬",
    ...
    text: "Pacote para atÃ© trÃªs residÃªncias ou espaÃ§os que precisam de equilÃ­brio.",
    title: "HarmonizaÃ§Ã£o de Ambientes Â· 3 ResidÃªncias",
  },
  {
    amountCents: 10599,
    badge: "OrientaÃ§Ã£o",
    description: "SessÃ£o online para leitura de tarÃ´ e leitura de campo energÃ©tico.",
    duration: "1 hora",
    ...
    text: "Leitura para questÃµes especÃ­ficas com orientaÃ§Ã£o espiritual online.",
    title: "TarÃ´ e Leitura de Campo",
  },
  {
    amountCents: 19599,
    badge: "Estendida",
    description: "Formato ampliado para quem precisa de mais tempo de leitura e integraÃ§Ã£o.",
    duration: "2 horas",
    image: "/services/original-tarot-field-reading.webp",
    price: "195,99 â‚¬",
    ...
    text: "Leitura estendida para perguntas mais profundas e campo energÃ©tico.",
    title: "TarÃ´ e Leitura de Campo Â· 2 horas",
  },
  {
    amountCents: 10590,
    badge: "Chakras",
    description: "SessÃ£o Ã  distÃ¢ncia para harmonizaÃ§Ã£o, desbloqueio e restauraÃ§Ã£o dos sete chakras principais.",
    duration: "Ã€ distÃ¢ncia",
    ...
    text: "Cuidado focado no equilÃ­brio dos centros energÃ©ticos.",
    title: "Desbloqueio dos 7 Chakras",
  },
  {
    amountCents: 26799,
    badge: "Apoio",
    description: "Tratamento Ã  distÃ¢ncia com primeira consulta, orientaÃ§Ã£o e cuidado energÃ©tico estruturado.",
    duration: "15 dias",
    ...
    text: "Apoio energÃ©tico intensivo com consulta e acompanhamento inicial.",
    title: "Tratamento para DepressÃ£o + Consulta",
  },
  {
    amountCents: 69000,
    badge: "ContÃ­nuo",
    description: "Plano contÃ­nuo de trÃªs meses para suporte energÃ©tico em processos emocionais prolongados.",
    duration: "3 meses contÃ­nuos",
    image: "/services/original-depression-support.webp",
    price: "690 â‚¬",
    ...
    text: "Acompanhamento energÃ©tico contÃ­nuo durante trÃªs meses.",
    title: "Tratamento para DepressÃ£o Â· 3 meses",
  },
  {
    amountCents: 26799,
    badge: "Apoio",
    description: "Atendimento Ã  distÃ¢ncia com consulta inicial e plano de apoio energÃ©tico para enxaqueca crÃ´nica.",
    duration: "15 dias",
    image: "/services/original-energy-cleansing.webp",
    price: "267,99 â‚¬",
    ...
    text: "Apoio energÃ©tico com consulta para casos de enxaqueca crÃ´nica.",
    title: "Tratamento Enxaqueca CrÃ´nica + Consulta",
  },
  {
    amountCents: 69000,
    badge: "ContÃ­nuo",
    description: "Plano de trÃªs meses para apoio energÃ©tico contÃ­nuo em processos de enxaqueca crÃ´nica.",
    duration: "3 meses contÃ­nuos",
    image: "/services/original-energy-cleansing.webp",
    price: "690 â‚¬",
    ...
    text: "Acompanhamento energÃ©tico contÃ­nuo para enxaqueca crÃ´nica.",
    title: "Tratamento Enxaqueca CrÃ´nica Â· 3 meses",
  },
  {
    amountCents: 15099,
    badge: "TransiÃ§Ã£o",
    description: "Atendimento sensÃ­vel para apoio espiritual e energÃ©tico em momentos de fase terminal e transiÃ§Ã£o.",
    ...
    text: "Acolhimento energÃ©tico em processos delicados de transiÃ§Ã£o.",
    title: "Apoio Fase Terminal e TransiÃ§Ã£o + Consulta",
  },
  {
    amountCents: 11499,
    badge: "Cura guiada",
    description: "SessÃ£o online de 1 hora. Recomenda-se sala privada, fones de ouvido, Ã¡gua em copo de vidro e, opcionalmente, Selenita branca e Turmalina negra.",
    duration: "1 hora",
    ...
    text: "SessÃ£o guiada de cura energÃ©tica com formulÃ¡rio obrigatÃ³rio no checkout.",
    title: "Movimento de Cura Guiada com Equipe Seriana",
  },
  {
    amountCents: 10599,
    badge: "Clareza",
    description: "Atendimento Ã  distÃ¢ncia voltado para confusÃ£o mental, peso emocional e recentramento.",
    duration: "1 hora",
    image: "/services/original-tarot-field-reading.webp",
    price: "105,99 â‚¬",
    ...
    text: "SessÃ£o para clareza, leveza mental e organizaÃ§Ã£o energÃ©tica.",
    title: "AlÃ­vio Mental Imediato e ConfusÃ£o Mental",
  },
  {
    amountCents: 20499,
    badge: "Intensivo",
    description: "Atendimento intensivo de duas horas para processos densos, traumas, bloqueios e movimentos de libertaÃ§Ã£o energÃ©tica.",
    duration: "2 horas",
    ...
    text: "SessÃ£o profunda para padrÃµes, bloqueios emocionais e libertaÃ§Ãµes.",
    title: "SessÃ£o Intensiva: Traumas, Bloqueios, Banimentos e LibertaÃ§Ãµes",
  },
  {
    amountCents: 55599,
    badge: "Pacote",
    description: "Pacote para acompanhamento mais profundo em trÃªs sessÃµes intensivas de duas horas.",
    duration: "3 sessÃµes Â· 2 horas cada",
    image: "/services/original-trauma-intensive.webp",
    price: "555,99 â‚¬",
    ...
    text: "Pacote de trÃªs sessÃµes intensivas de duas horas.",
    title: "3 SessÃµes Intensivas: Traumas, Bloqueios e LibertaÃ§Ãµes",
  },
  {
    amountCents: 99699,
    badge: "Acompanhamento",
    description: "Plano ampliado para processos extensos, com seis sessÃµes intensivas de duas horas cada.",
    duration: "6 sessÃµes Â· 2 horas cada",
    image: "/services/original-trauma-intensive.webp",
    price: "996,99 â‚¬",
    ...
    text: "Plano completo de seis sessÃµes intensivas de duas horas.",
    title: "6 SessÃµes Intensivas: Traumas, Bloqueios e LibertaÃ§Ãµes",
  },
];
