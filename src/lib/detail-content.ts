...
export const aboutPageContent: Record<Locale, AboutPageContent> = {
  ...
  en: {
    ...
    title: "Hi! I am Dani",
    intro: [
      "I am a Spiritual Noetic Healer and an Educator in the Awakening of Consciousness, working across therapeutic, spiritual and energetic care.",
      "My mission is to guide people back to their essence, restoring vital energy, aligning the subtle bodies and reconnecting each Being with their deepest truth.",
      "I channel high-frequency spiritual teams, consciousnesses that accompany me in work focused on healing and reconnection with the essence.",
      "Through sensitive listening, spiritual readings, intuitive channeling and restorative practices, I act as a bridge between planes: the visible and invisible, the mental and spiritual, the human and divine.",
      "As a Spiritual Noetic Healer, I access higher dimensional levels in direct communication with higher consciousnesses.",
      "Every process I lead is unique, guided with presence, respect and intuitive precision.",
  ...
  nl: {
    ...
    intro: [
      "Ik ben Spiritueel Noëtisch Healer en begeleider in het Ontwaken van Bewustzijn. Mijn werk is therapeutisch, spiritueel en energetisch.",
      ...
      "Ik channel spirituele teams met een hoge frequentie, bewustzijnen die mij begeleiden in werk rond heling en herverbinding met de essentie.",
      "Via aandachtig luisteren, spirituele lezingen, intuïtieve channeling en herstellende praktijken vorm ik een brug tussen werelden: zichtbaar en onzichtbaar, mentaal en spiritueel, menselijk en goddelijk.",
      "Als Spiritueel Noëtisch Healer bereik ik hogere dimensionale niveaus in directe communicatie met hogere bewustzijnen.",
      "Elk proces dat ik begeleid is uniek en wordt met aanwezigheid, respect en intuïtieve precisie geleid.",
      "Samen met mijn spirituele teams bied ik cursussen aan die de subtiele zintuiglijke waarneming verdiepen en het bewustzijn op meerdere niveaus verruimen via gechannelde lessen, vibrationele oefeningen en groei van het Zijn.",
    ],
...
const courseDetails: Record<Locale, string[]> = {
  ...
  en: [
    ...
    "We will practise Guided Energetic Movement and sensory-field perception exercises, developing independence and restoring the natural sensitivity that belongs to us by essence.",
