...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: {
      ...
      en: "A short guide to noticing when your body, home or mind may be asking for an energetic pause.",
      es: "Una guía breve para notar cuándo el cuerpo, la casa o la mente piden una pausa energética.",
      nl: "Een korte gids om te herkennen wanneer je lichaam, huis of geest om energetische rust vraagt.",
    },
  ...
  },
  {
    ...
    excerpt: {
      ...
      nl: "Hoe je je ruimte, intentie en ritme voorbereidt op een online sessie.",
    },
  ...
  },
  {
    ...
    excerpt: {
      ...
      en: "A gentle introduction to environment harmonisation, without overwhelm.",
      es: "Notas para comprender la armonización de ambientes sin exceso de información.",
      nl: "Een rustige kennismaking met harmonisatie van ruimtes, zonder overdaad aan informatie.",
    },
