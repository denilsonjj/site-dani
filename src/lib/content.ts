...
const content = {
  ...
  en: {
    ...
    course: {
      ...
      title: "Movimento de Cura Guiada com Equipe Seriana",
      intro: "A guided vibrational movement with the Seriana Team, focused on releasing emotional and energetic ties, strengthening the self and supporting inner reconnection.",
      price: "114.99 €",
      duration: "1 hour · online via Zoom",
      cta: "I want to enrol",
  ...
  es: {
    ...
    course: {
      eyebrow: "Curso online",
      title: "Movimento de Cura Guiada com Equipe Seriana",
      intro: "Movimiento vibracional guiado por el Equipo Seriana para liberar ataduras emocionales y energéticas, fortalecer el ser y favorecer la reconexión interior.",
      price: "114,99 €",
      duration: "1 hora · online por Zoom",
  ...
  nl: {
    ...
    course: {
      ...
      title: "Movimento de Cura Guiada com Equipe Seriana",
      intro: "Een begeleide vibrationele beweging met het Seriana-team, gericht op het loslaten van emotionele en energetische banden, innerlijke versterking en herverbinding.",
      price: "114,99 €",
      duration: "1 uur · online via Zoom",
