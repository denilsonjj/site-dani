...
const content = {
  pt: {
    ...
    course: {
      ...
      title: "Formação espiritual com inscrição simples",
      intro:
        "A pessoa manifesta interesse, informa apenas nome, idade e e-mail, e depois recebe as orientações da turma e do pagamento.",
      price: "A partir de 35 € por encontro ou 200 € antecipado",
      duration: "6 semanas · encontros online · horário CET",
  ...
  en: {
    ...
    course: {
      ...
      title: "Spiritual training with a simple enrolment form",
      intro: "The client registers interest, shares only name, age and email, then receives the class and payment instructions.",
      price: "From 35 € per meeting or 200 € upfront",
      duration: "6 weeks · online meetings · CET schedule",
      cta: "I want to enrol",
  ...
  es: {
    ...
    course: {
      eyebrow: "Curso online",
      title: "Formación espiritual con inscripción simple",
      intro: "La persona registra su interés, informa solo nombre, edad y email, y después recibe las orientaciones del grupo y del pago.",
      price: "Desde 35 € por encuentro o 200 € anticipado",
      duration: "6 semanas · encuentros online · horario CET",
  ...
  nl: {
    ...
    course: {
      ...
      title: "Spirituele training met eenvoudige inschrijving",
      intro: "De persoon toont interesse, deelt alleen naam, leeftijd en e-mail, en ontvangt daarna groeps- en betalingsinformatie.",
      price: "Vanaf 35 € per bijeenkomst of 200 € vooraf",
      duration: "6 weken · online bijeenkomsten · CET-tijd",
