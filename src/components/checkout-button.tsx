...
> = {
  pt: {
    ...
    paymentFallback: "Pagamento em preparação. Entre em contacto pelo WhatsApp.",
  ...
  en: {
    ...
    paymentFallback: "Payment is being prepared. Please contact us through WhatsApp.",
  ...
  es: {
    ...
    paymentFallback: "El pago está en preparación. Contacte por WhatsApp.",
  ...
  nl: {
    ...
    paymentFallback: "De betaling wordt voorbereid. Neem contact op via WhatsApp.",
